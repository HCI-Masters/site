...
Μια άλλη πρακτική χρήση του EyeTap θα ήταν σε ένα εργοτάξιο, όπου θα επέτρεπε στον χρήστη να προβάλλει τρισδιάστατα ψηφιακά σχεδιαγράμματα που συμπληρώνουν  το κτιρίο στην τρέχουσα κατάσταση του.
